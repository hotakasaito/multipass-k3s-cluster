...
get_release_version() {
 ...
 download() {
   ...
   case $DOWNLOADER in
     aria2c)
       aria2c -x5 -d $(dirname $1) -o $(basename $1) $2
       ;;
     curl)
       curl -o $1 -sfL $2
       ;;
...
"
 ...
 download_and_verify() {
   ...
   setup_verify_arch
   verify_downloader aria2c || verify_downloader curl || verify_downloader wget || fatal 'Can not find curl or wget for downloading files'
   setup_tmp
   get_release_version
   download_hash
